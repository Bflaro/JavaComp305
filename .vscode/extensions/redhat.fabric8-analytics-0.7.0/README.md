...
- **Component analysis**
	...
	**NOTE:** Add the `target` folder to your `.gitignore` file to exclude it from Git monitoring.
	...
	![ Animated screenshot showing the inline reporting feature of Dependency Analytics ](https://github.com/fabric8-analytics/fabric8-analytics-vscode-extension/raw/HEAD/images/screencasts/component-analysis.gif)
